...
const DecisionPathChancePodScr = ({navigation, route}) => {
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../alkmmdwmwem/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../alkmmdwmwem/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default DecisionPathChancePodScr;
